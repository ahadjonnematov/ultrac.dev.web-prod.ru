...
register_nav_menus(array( // Регистрируем 2 меню
	'top' => esc_html__('Верхнее','Главная'), // Верхнее
	'bottom' => esc_html__('Внизу','artbt'), // Внизу
));
...
function my_acf_google_map_api( $api ){ $api['key'] = 'AIzaSyC_q1Jt1GCqhHHIgWQabcCcRdDodnpCJPI'; return $api; } add_filter('acf/fields/google_map/api', 'my_acf_google_map_api');
